...
contextBridge.exposeInMainWorld("electron", {
  ...
  readOutputs: (outputsDir: string) =>
    ipcRenderer.invoke("read-outputs", outputsDir),
  getHomeDir: () => ipcRenderer.invoke("get-home-dir"),
  openDirectory: () => ipcRenderer.invoke("open-directory"),

  // Canvas persistence
  saveCanvas: (projectDir: string, data: string) =>
    ipcRenderer.invoke("save-canvas", projectDir, data),
  loadCanvas: (projectDir: string) =>
    ipcRenderer.invoke("load-canvas", projectDir),
  bootstrapProject: (projectDir: string, runtime: unknown) =>
    ipcRenderer.invoke("bootstrap-project", projectDir, runtime),
  ...
  assistant: {
    ...
    stop: () => ipcRenderer.send("stop-assistant"),
  },
