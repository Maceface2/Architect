...
import { palette, categoryOrder, categoryLabels, ZONE_PALETTE_ITEM } from '../../data/componentPalette'
    ...
    <div className="flex flex-col bg-panel border-r border-node-border h-full overflow-y-auto py-2">
      <div className="mb-2">
        <div className="px-3 pt-3 pb-1">
          <span className="text-[10px] font-semibold tracking-widest text-slate-500 uppercase">Zones</span>
        </div>
        <PaletteItem item={ZONE_PALETTE_ITEM} />
      </div>
