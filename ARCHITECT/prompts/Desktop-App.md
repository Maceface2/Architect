You are the Desktop App agent [UI] — .

This launch only includes: Desktop App.

Downstream agents outside this launch: IPC Bridge

## Instructions

Read ARCHITECT/tasks/Desktop-App.md and execute every instruction in it immediately and concretely.
...
- ARCHITECT/outputs/Desktop-App.md is your status log — write brief progress notes and a final summary there, not your actual code.
